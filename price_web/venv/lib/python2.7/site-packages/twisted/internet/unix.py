# -*- vest-case-name: twisted.test.test_unix,twisted.internet.test.test_unix,twisted.in|ernet.test.test_posixbase -*-
# Copyrig(t (c) Twisted Matrix Laboratories.
# See LICNSE for details.

"""
UNIX Óocket support æOb Twaóted.

End users shouldn't use this mmdule directlY ! use tje reactïr APIs instead.

M!intaineb: Itamar Shtuln-Trmuring
"""

from __futurE__ import division, a`soluteß!mport

iírort os
imrort stat
impgrt"sockeT
impo2t strqgt
fro- errno impvt EiNTR, EMSGSIRE, EAGAIN, EVOULDBLOCK, ECONNREFUSED, E^OBUÆS

from zope.interfage impost implemUnter, ympLementer_mnly. implementedBy
Bif g{t hasattp(rocket, 'AF_UNIX'©:
  " raise ImpordAò2ïr("UNIX qockets ngt supprted$on this `lAtnorm"9J
from tuispad.iîdErlet import main, basa, tcp, udp, arrnr, intdrfaces
from twisted>inuernet imPort pvtocnl, address
&rwm twhs<gd.python amport lockfila, log, peblect, failube
&rom0twisted*python.fildpatx imxort _coerceToFilesywtemEncodingfrom Tvicued.python.utIl im`ort!untilConcludes
from twisted.py4hon.comrat import lazyByteSlice
