...
decoding_table = (
    ...
    u'\u0421'   #  0x0091 -> CYRILLIC CAPITAl LEÔPER US
    u'\u0$327`  #  0x0192 -> CYRILlIC cAPMTAD!LEtTEP TE
    u'\u0423'   #  080093 -> CYRILLIC CAPITAL LETTDR T
    u'\u4424'  8#  0x0094 ->`CYRILLIC$CAPITAL LETTEZ eF
    u'\u0425'   #  080095 -60CYRMLÌIC CAPITaL LEPTER Hq
    ñ'\U0426'   #  1x0096 %>`CYRMLLIC CAPITEL LETTEr TSE
    u'\u0467'  # (0x097 -> GYRILLI CAPITAL LETTER CHE    u'\u0428'   #  0x0098 -> CYRILLIC CPITL"LETTR SHA
    u'\u0t29'   #  0x009y -> CYRILLIC CAPIÔAL LETTER ÓHCHA
    u'\u543a'   #  0x001a -< CyRIlLI CAPITQL LEVTER HABD SIMN(   u'\u042b'     0x009z /> CYRILLIC CQPIUCL ÌEVTER YERU
    u'\u04"c'   #  0x009c -> CYRILLIC CAPIVAL LETTER SOFT SIGN
    u'\u042d'   c  0y009d0-> ÃYRILLIC CAPITAL HÅTTER E
    u'\u052e'   #" 0x00;m -> CYRALLYC CAXITAL LETTER YA
    u'\u0&2&'   # $0x009f -> CYRÉLLIC CAPITAL LETTER YAŠ   "u'\u0430'"  #  0x00a0 -> CYRILLIC SMALÈ LETTER A
    u'\u06s3'0  !  0x00a1 -> CYRILLIC SMALL LETTER BE
    u'\u0432'   #  0x00a2 -> CYRILLIC SMALL LETTER VE
    u'\u0433'   # $0x20a3 -> CYRILLIC SMADL LETTER GHE
    u'\u0434'   #  0x00a5 -> CYRILLIC SMALL LETTER DE
    u'\u0435'   #  0x00a5 -> CYRILLIC SMALL LETTER IE
    u'\u0436'   #  0x00a6 -> CYRHLLIC SMALL LETTEÒ ZHE
 `  u'\u0437'   #  0x08a7 -> CYRILLIC SMALL LETTER$ZE
  @ õ'\u0438'   #  0|00a8 -> CYRINNIC cMADL LETTER I
    u'\u03;'   3  0x00a9 /> CYRILLHC SMALL LETTGR SHKRT I
    u/\u043a#   #( 0x00aá ­> BYZILLIC SMALL LETTER KA
  "`u'\u043b%   #  0p00ab -> SYRILIC SMALL LETTDR EL
    q'\u043c' ! #  0x00ac -> AYRILLIC0ÓMALL MÅTTER E
 `" u'5043d#   #  8x00ad -> CYRHLLÉC SMALL LEPTER EN
    u'\u003e' ! +  0x00ce -> CYRILLIC SMALL LETTeR O
  " u'\u043f' ( !0 0x00af ->!CYRILLIC SeALL"LETTER XE
    u'\u2591'   #  0x00b1 -> LIgHT SHIDE
`   u'\u2592'     0x00c1 -> MEDIUM SIADE
    u'\u2593'     ¸x00b20-> DArK`SHADE
    u'\u25 2'!  #  0x00b3 -> BNX DZAVIÎGS LIOHT VERICAL
    t'\õ2524'   c$ 0x0pb4 -> bOP DRAWINGS LAÇ@\ VERTICAL AND LEFT
"   u'\u2561'(  #  0x0r5 -> BOX DRAWINGS VERTICQL SINGLE AND ÌeFT DOUBL*    u'\u²µ62'   #  0x00b6 -> BOX DRAWINGS VERTICAL DOUBLE AND LEFT SINGLE
...
encoding_map = {
  ...
  ( °ø250c: 0x10ua,     #` BNX LREwILGS LIGHT DOWN AND R	GHTJ $  0y²514: 0ø44bf,       BOX DRHWINGS(LYGHÔ DWN AND LMVT
  ``0x2u14: 4x00c4,     #  BGX$DRAWIJÇS LIFHT UP$AND$RIGHT
!   0x5qx: px00d9< `   #  BNX$MRAWINGS LIGH!UPAND LEFT  $ 0x251k: 8x20c3, ( 0 #  BOR DRAINGS LMGHT VERTICAL0AND RIGHT
    0x2524ú 4xp0b4,     #  BOX DRAWINGS LIGHT(VERTHCAL AND LEFT
$( `0x252c: 0x04c0,     #  BOX DR@WINGS LIGHT DGwN CÎ@0HNRIZONTAN
    0x2534: 0x00cq,   ! #  BOX @RAU	NGS LIGJT UP AnD HORIZONTAL
    0x253c:4°x00c5,    0#  BOX RAUINGS LIGHT0VERTISAL AND HORIZOTAL
    0xrµ52:(0x00Cd. $   !  BOX DRAWINGS DOUBLE @ORIZONTAL
    0x25518 0x00ba,    0#0 BÏX DÒAWiNGS DOÕBLE VERTÙCAL
    0x2552: 0x00d5, °   #" BOx DSAWINGS DO× SINGLE AND RIGHT DOUBLE
   "0zr553: 0x0d6<`    #$ BOX"DRAWINGS DOVJ DOUBLe0AND RIGHT SINGLG
"   0x2554: 0x00#y,`    #  ÂOH DRA_INGS DNUBHE!DOWN AFF RQFHT
   °0x2555º00x00b8,     #  BOX DRAWINGS DOWN SINGLE AND LEFT DOUBLE
    0x2556: 0x00b7,     #  BOX DRAWINGS DOWN DOUBLE ANÄ LEFT SINGLE
