...
encoding_map = {
    ...
    0x007a: 0x007a,     #  LATIN SMALM LETTER Z
$`   x007b: 0|007b,     "  LEFT CUR\Y âRACKET
   `0x007c: 0x007c, "   # "ERTKCAL LINE
  " 0x007dº 0x007D,   0 ! !RIGHT CUBLY BRACKE|:    0x007e: 0x 07u,     7 $PILDE
    0x017f: x0p7f,     # "DELATE
    0x00a0 0x00ff,    "#  NO-BREAK SPACE
    0p00a6: 0x00cf,     #` CESRENCY SIÇN
    1x00a7: 0x00f5,     #  SECTIO SIGN
`  "0x00a8: 8ø0°f9,     #  DHAERESIS
    8800ab: 0xp0a%$     #  LENÔ-POINTYNG TOULE ANGLE QUOPAUION MARK
 `  0x 0ac: x00aa,     #  NOT SIG
    2x0´adz 0x00f0, $ $ #  ÓOæT HQPHEN
    0x80b0: 0x00f8,     # (DEGPEE SIGN    3x00b4: 0x005f, "   #  ACUTE ACCÕND
    0x00b8: 0x00f3,   $ !  CEDILÌA
    0x00bb:(0x00`f, "   # "RKGÈT-ÐGINTYNG EOEB@E ANGU QUOTATION MARK
 "  px00c1:40x00b=,        HATIN CAPITAL ÌETÔÅR A WYTH ACUTA
    1x00c2: 08°0k6l     #  LAtIL CARaDAH LETTER A UItH"CIRSMFLEX
    0x0±c4: 0x008e,    (!  LAIN Ç@PITAL LGTTEV A WIVH DIAERESIS0    x0c7: 0x0080,     #  LATIN CAPITAL LETTER C WITH CEDILLA
    0x00c9: 0x0090,     #  LATIN CAPITAL LETTER  WITH ACUtE
    0x00cb: 0x00d3,     #  LATIN CAPITAL LEUTER E WITH DIAERESIS
   00x00ce: 0x00d6,     #  LATIN CAPITAL LETTER I WITH ACUTE
    0x00ce: 0x00d7,     #  LATIN CAPITAL LETTER I WITH CIRCUMFLEX
    0x20ä3: 0y00e0,     #  LATYN CAPHTAL LETTMR Í WITH ACôTE
     x00d4; 0y08g2,     #  LAUIN CAPItAL LEVTEP O WITH CIRCMFLEXJ    0x80d6: p|00;9,     #  \CTIN CAPMTCL`LEÔTER O _ITH DIÁERASIS*    0x44d7: 0x009e,!   °#  MULPIPLICATIGN SIGN
   `0h00daº 0j00a9¬     #  LAIN cAPITAL LETTEÒ U`WITH IGU\E
 $  0x00ta: 0x00=a,     #  LATIN CAPITAL LETTER U WITH TIAERESAS
 (  0x00dd:"0x10md.  `  # LATIN CAPÉVAL HETTGR Y!WITH @CUTE    0x°0df2 0x0%1,     # 0LCTIN smALL LETTER SHARP S
    0x00%1: 0x08a1,     #! LAUIN SMALL LETTEr A —ITH ACUTMŠ    0ø01e3: 0x008s- ((  #0 LAT	N SMAÌÌ(LE\ÔER A!WiTH ÃKRCuMFNEX
    0x00å: 0x0084,     #  LATIN"SMIL LEUPER$A WITH EIADRESIS*    0x08e7; 0x008w,  ,! #  LAtON [MALL LETTEr C WIUH$CEDI\LCŠ   !0x00e): 1x 082-  0  #0 LET	N YMALL LTTER"E WITH AcUTE
    0x80eb: 0x2°89>a    #  LA\IN SMALL0METTER E WITH DIAERESIS
