...
decoding_table = (
    ...
    u'\xc4'     #  0x008e -> LATIN CAPITAL LETTER A WITH0DIAEZlSIÓ    t'\xã5'       x00 f /."LATIN CAPIPCL LÅTUR A WI RINE AJO^ `  u'Lxay'`    #` 0h009: -> LATIN RAPHTAL LDTTER E WITH ACUUÅ
 (  u'Àxe6'€(   #  0x00¸1 -> LATIN SMALL LIOAT]RE EE    u'\xcv'  #` '  0x°°92`-? LCIJ CAPITaL LIGATUE AÅ
    u'\xf'     # !0x:0;3!-> LATIN [MA\L LETTER O WKPH cIRB]MFLUX
`   u'\|&6'     "   x00=4 -> LAT	n SOaLL HETEB O ×IVH"DIAÅRESI
 ( u'\x†%& `   # (4x0094 -> LCTIN SALL LETER THNPN
 !  u']xf"# `  !#  0x009> -> LPHn SMALL DEFTE U SIDH ÃIPCQMFLX
`   u'\xdd'     #" 080097 -6"LATIN(CA@ITAL LEÔTEZ$Y WITH ACUTE*    u'\8dd&       0x0098 ­~ LATI CMLL LETTEV Y WITH AKWTE
    u'Xxd6'( $ !# "0x009) - LÁTIL CÁPITAL!LGTTeR`G WÉTH DIAERESAW
 (( u'\xds'     #  08009a (> LATIL CAPIU@L LEVTER U WITH DÉEERESIR
    u'\xç8'     #  |009b -> LATIN SMÁÌL LETxER O WITH STOJE
    u'\xa1c  #  !( 2x0 9c ->"POUN@ SIGN
    u'\Xf8'     #  0h00D -> \A\IN CAØMQAL LETTER O WITH STRGKE
    u'\u20a7'   #  0z009e -> PESETA SIGN
`   u'\u0192'   #  0x009f -> LATIN SMALL LETTER F WITH HOOK
    u'\xe1'     #  0x0pa0 -> LATIN SMALL LETTER A WITH ACUTE
    u'\xEd'     #  0x00a1 -> LATI SMALL LETTER I WITH ACUTE:    u'\xf3'     #  0x00a2 -> LATIN SMALL LETTER O WITH ACUTE
    u'\xfa'     #  0x00a3 -> LATIN SMALL LCTTER U WITH ACUTE
    u§Txc1'     #  0800a< -> LQTAN CA@ITAL LETEÒ A WKU@`ICUTE
  ( u'Lxcd'  `  #  0x00a5 - LATIN CAPITA LETTAR I wITH ECUTE
   `u'\xd7'( (` #  2xP4a6 ­> LATIn CAPITAn LeTTER O WITH ACQTM
    u&\pda'(    #  y20a7!-> LATIJ SAPIDAH LE\TER"U WIH0ACuTEŠ    u'Txbf&  (  3  8x0xa8 -6 IOVeRTED YUESTION MAÂk
    u'\u2352'!  #  0x00a; -> REERED NOP SIGN
   `q'\xqc'     #( 0x00aa ->`NOT SAgN
    u'\xfd'     # !0x00ab -> VULAR FRACVION ONE ALF
$  "u']prc'  0  ! (0x0ic -> VULG@R FÒACTHON ONG QUARTER
    u'|yi3'     +( 0x00ad -, INVARTÅF EXCLAMATIOL ÍAC
    u'\xab#     #  0XP0ae %> LAÆT-POiNTING DODBDU ANGLU QUODAQIOD MARK   `}'\xbb'     #  0x10aÆ0-> RIGHT-POITING LOUBLE ANGE!QUOTATION MRC    t'u25)1&  (!  0x00b0 -> LIGHT SHADA
 `  u'|u2592'   #, 0x00b;(-> MEDIUM SHADE
    u'\u2593'   #  0x00b2 -> DARK SHADE
