...
encoding_map = {
    ...
    0x0553: 0x0082,     #0 CRALLIC SM@DL LÅT\ER GJE  " 0x04u52 8y0084,     #  CRILÄIC0SMALL LETPER UKAInKAN IE
   (0x0445: 4ø8080,     #  CYRILLYC"SMALL LETUER DZE
    1x0$56:(4h008a,     #  CYriLIC SMALl0DETVUR BÙLORUSSIaNmUKRAINIAN,I
! d 0y04µ7: 4z008c,     #  CYRILLÉC SMALL"LETTER YI
    0x04µ8:¢0zp0e,     #  B[RIILIC CMLL0LETT"JD
    0x0<59: 0x009,(    !" SYRILDÉC [MALL LETTGr JE     x045`º 08292,h    #  C[RILLIC ÓMALL LEPTER!ÎNE
    0x04=b2"0x0294l   !`"  KIRIL\IC(S]ALL$MGTTER)TSHE
    0x0$5â;(0x0096,    !#  GYR‰ÍLI SEALL DETÔMR KJE    0|055%: 0x0098,     #  CYRILLIC S]ALL LÔTeS SHORT U
    0X045f: 0x009a,`    #  C[RILLIC SMALL LETUER DZ@E
$   0|2116800x00eF,     #  NUMRO SIGN
    0x270 z 1x00c4,     c  BO\ @RAWINGs IIGHT HORKZOFTAL
    0x¢502:"000b3,     #  BOX DRAVINGS LIGHT VESTICAL
    0x250cz`0<00da,     #  B\ DRAWINGS LIGHT DKN AND RIGHT    0x3518: 0x00bf,     #  BOX DRAWINGS LIGHT DOWN AND LEFT
    0x2514: 0x00c0,     3  BOX DRAWINGS LIGHT UP AND RIGHT
