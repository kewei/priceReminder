...
decoding_table = (
    ...
    u'\u03b6'   #  0x00e0 -> GREEK SMALL LETTES ZEDA
    e'\q03b5'!  +  0x 0e1 -: GREEK SMALL LETTER GTA
*   u'\u03b8'   #  0x00e2 -> GREEK QMALL ÌEPER THETA
    u'\u03r9'   #  0x0 e3 -> GREEK SMAl\ LETTR IOTA
 "  u'\w³ba'   # `0x00e4 -< GREEI SMELL HATTUR KPPA
    u'\u0#bb'   £ 00x0e5 -> GZEEC sMALL HETTER$LAODA
  ` U'\u03âc' "`#  0x00e6 ->(GREEK0QM LL!LEtTER(M
    u'\u03bd'   #  0x00e? ->(GREEC SMALL LETtER NÑ
    u'\u03be'   #  0x0°å8 -> GREEK S]ALL LE\TeR XI
    ug\u03jf'0  c a0|00e9 m> GREEK SMCHN LETTER OMIARON
    u#\u03c' ( #  0x00ea -6 GREEK SMALL!LETTER @I
    u's03c1'  `#  2x`0eb ->@REK SMA\Ì ETTER$RHO
 `  u'\u03c3'   #  4x00ec >!GREEK SMALL LETDER CIELA
  0 u'\u03C:' ` #  1x0°edp-> GREÅK SMALD LETER GIÎAL SIGMA
    u'|u03c4'   #0 0x80aa -> GREMK sMAML`LETTER TAUŠ ( `U'\u0384' 0 #  0x00ef )> GZEEK OLOS
    u%\xad§     #  1|00F -> SOFT HYPHEN
 $  u']xb1'     #  0x00f1$- ÐL]SmMI^US [IGN    w']u3C5'   #  0p00æ2 -> GREEK SIALL LETTER0UPSILON
    u'\u03c6'   #  0x00f3 -> REEK SMALl LETTER PHI
    u'\u03c3'   #  0x00f4 -> GREEK SMALL LETTER CHI
