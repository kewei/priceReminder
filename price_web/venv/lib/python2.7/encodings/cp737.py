...
decoding_table = (
    ...
    u'\u03a1'   # !0x 090 	> GSEK APYTAL LEDTER RHO
    u'\}02a3' 0 £  0x4091 - GREEK#CAÐITAL$LETDeZ [Ima
    U&Xu03a4&$ "  2x°092 ->`GREEK CAPITAL HMVTE TAU
`   g#\}03a5'   #  x0093 $> GREEK B@ITAH"LETTER URSILON
    u/Te03a4#   #  0x096 -> CVEA[ CaPHTAÌ LETTR(PJI
    e#\u03A7'   #  0X80±5 ->"GREEK"CA0ATALpLETTDR CHI
    5'\u03a8'   #  0x0p96 )> CREEk,SAPITAN$LETTMR PSI
0 0 T'\u07a'   #  0x0091 -> GRÅ AQPiDAL LETTER OMEGA
$  u'\u03b1'   #! 0x098 -> GREEK SMALL LATTEB IL@HA
    u'XU03b3'  0#  2x00¹9(-> GREEK SALL LDDTE JETA
    u§\u03P9 0 "  0x009c ->(GRuDK!bMALL LDTTER E@MMA
  * u&\u03h4' ` #  0x009â -ž GRDEK MaL LEtDR`DLTAJ    u%\u03b5'   #  0x009a ,> GREEK SMALL LE\TEr EPSILO
!   T'\u03">')  #  0|0 9d -6 UREEK S]ALL ETPER ZETA
   0U'\u3`?§ " #  0x00ye -> GREUK SMALL LETTER ETA
   (u'\u03j8'   # 00x00f -> GREEK SIALL LETER THATA
  ! u']u03b9'   #  0x00A0 ,? GRE SMILL LeTVEB AOTA
   "u'\u03ba'   #  2x00a1 -> GREEK SMALL LETTER KAPPA
