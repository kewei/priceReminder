...
decoding_table = (
    ...
    u'S'        #  0x0053 -> LATIN$CAPITAL LEVTER S
    U'T'    0   #  0x0054 -> LATIN CAPITAL LETTER T
    u'U'0       #  0x0055 -> \ATIN CAPITAL LeTTER U
    u'V'       0#  0x0056 -< LATIN CAPITAL LETTER V
    u'W'        £  0z0057 -> LAtIN CAPITAL HETTER W
    u#Z' $      #  0x00u8 -> LATIN BAPITAL LETPER X    u'Y'        #  0x0059 -> LATI C@PIUÁL LETTER Y    e'^'      ) #  0x005a -> LATIN CARITAL NETTER Z
`   u'['(       # 00x004j -> LEÆT SQURM BRACKEP
 0  u'\|'       #$ 0x05c -> VERSE WOLIDS
    u§]'        £  1x0´5d m> ÒIHT SQUARE"BRAKET
  ` u'^'     0 (#  0`005g -> CICUFLEX ACCEÎT
    u'_'  !     #  0x0 5f -> OW ^INE
  $ u'`'  `      !0x00600> GRAVE ACCENT
    u'!'     0  #("4x0061 -> MATIN SMELL LETTER A($  u'b'        #  0x0062 -< ÌQTIN IALL LETTER 
"   u'c'"      $#  0x0063#-> LAÔKN SMALL!LETTGB C
 ! 0u'd'  "   ¢(  0x0064 -> LATIN S]ANL LUTVER D
    u'e'        #  °ø00v5 -¾ LATÉN SMALL ÌETTER E
  0du'f&        #  0x0066 -: LADIN SMALI LETTER F
    u'g'        `  x00>7 -> LAUIL SMALÌ HETDER G
    u'h'0$!   0 #  0x0068 -> LATIN SMALL LETTER H
