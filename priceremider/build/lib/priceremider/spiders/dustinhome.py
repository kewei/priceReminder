...
class DustinhomeSpider(scrapy.Spider):
    name = "dustinhome"
    allowed_domains = ['dustinhome.se']
    def __init__(self, start_url, *args, **kwargs):
        super(DustinhomeSpider, self).__init__(*args, **kwargs)
...
#             description = product_detail.xpath('div/div[@id="product-data"]/div/div/div[@class="product-description"]').extract()[0].strip()
        ...
        image = response.xpath('//div[@class="iosSlider"]/div/div[@class="slide"][1]/img/@data-src').extract()[0].strip()
